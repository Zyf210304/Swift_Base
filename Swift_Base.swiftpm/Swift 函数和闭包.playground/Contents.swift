...
func func2(param: Int) -> Bool {
    print(param > 60 ? "\(param) > 60" : "\(param) < 60")
    return param > 60
}
func2(param: 56)
...
let tuple = func3(param1: "param", param2: 10)
if tuple.result1.starts(with: "param") {
    print(tuple.result2)
}

//创建 带参 返回值类型为Optional
...
if let result = func4(param: 1) {
    print(result) //不满足条件 没有返回
}
...
// 函数内外参数命名
//函数参数指定外部名称
func outerNameFunc(name1 param1:Int, name2 param2:Int, name3 param3: Int) {
    print(param1, param2, param3)
}
//函数参数使用外部名称
outerNameFunc(name1: 1, name2: 2, name3: 3)

func normalFunc(param1: Int, param2: Int, param3: Int) {
    print(param1, param2, param3)
}
//默认 函数参数的内部和外部名称一致 调用函数时需要指定参数名称
normalFunc(param1: 1, param2: 3, param3: 3)

//可以混用
func outerNameFunc2(name1 param1:Int, param2:Int, name3 param3: Int) {
    print(param1, param2, param3)
}
outerNameFunc2(name1: 3, param2: 2, name3: 3)
...
//mutableParamFunc(param: 1...5)  不能用range
...
func func11(closureParam: @escaping (Int, Int) -> Void,closureParam2: @escaping (Int, Int) -> Void) {
...
func11 { value1, value2 in
    print(value1, value2)
} closureParam2: { value3, value4 in
    print(value3, value4)
}
